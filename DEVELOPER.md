# Building and Testing CustomLoggerService
...
See the [contribution guidelines](https://github.com/ialopezg/custom-logger-service/blob/master/CONTRIBUTING.md)
if you'd like to contribute to CustomLoggerService.

## Prerequisite Software

Before you can build and test CustomLoggerService, you must install and configure the
...
2. [Fork](http://help.github.com/forking) the [main CustomLoggerService repository](https://github.com/ialopezg/custom-logger-service).
3. Clone your fork of the CustomLoggerService repository and define an `upstream` remote pointing back to
   the CustomLoggerService repository that you forked in the first place.
